  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        followers: userData.followers || portfolioConfig.codingStatsFallback.github.followers,
        following: userData.following || portfolioConfig.codingStatsFallback.github.following,
        totalStars: totalStars || portfolioConfig.codingStatsFallback.github.totalStars,
        topLanguages,
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        followers: portfolioConfig.codingStatsFallback.github.followers,
        following: portfolioConfig.codingStatsFallback.github.following,
        totalStars: portfolioConfig.codingStatsFallback.github.totalStars,
        topLanguages: [
